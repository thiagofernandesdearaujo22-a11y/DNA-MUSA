[musa_plus_prototipo_29.html](https://github.com/user-attachments/files/32032365/musa_plus_prototipo_29.html)
<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
        ...
        '<div style="display:flex;justify-content:space-between;align-items:center;">' +
          '<div style="display:flex;align-items:center;gap:8px;min-width:0;">' +
            ...
            '<span style="display:flex;flex-direction:column;flex-shrink:0;">' +
              '<i class="ti ti-chevron-up" style="font-size:13px;cursor:pointer;color:' + (ei === 0 ? 'var(--border)' : 'var(--gold-soft)') + ';" onclick="' + (ei === 0 ? '' : 'moverExercicioTreino(' + di + ',' + ei + ',-1)') + '"></i>' +
              '<i class="ti ti-chevron-down" style="font-size:13px;cursor:pointer;color:' + (ei === d.ex.length - 1 ? 'var(--border)' : 'var(--gold-soft)') + ';" onclick="' + (ei === d.ex.length - 1 ? '' : 'moverExercicioTreino(' + di + ',' + ei + ',1)') + '"></i>' +
            '</span>' +
