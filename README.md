...
function renderCheckInEHabitos(nome){
  ...
  let html = '<p class="section-label" style="margin-top:0;">' + (editandoOntem ? 'Preenchendo o dia de ontem (' + dataFormatadaEmEdicao + ')' : 'Meu progresso hoje') + '</p>' +
    (editandoOntem
      ? '<span class="chip" style="cursor:pointer;margin-bottom:12px;display:inline-block;" onclick="voltarParaPreenchimentoDeHoje(\'' + nome.replace(/'/g,"\\'") + '\')"><i class="ti ti-arrow-back" style="font-size:11px;vertical-align:-1px;margin-right:4px;"></i>Voltar pra hoje</span>'
      : '<span class="chip" style="cursor:pointer;margin-bottom:12px;display:inline-block;" onclick="abrirPreenchimentoDeOntem(\'' + nome.replace(/'/g,"\\'") + '\')"><i class="ti ti-calendar-time" style="font-size:11px;vertical-align:-1px;margin-right:4px;"></i>Esqueci de preencher ontem</span>') +
    '<div class="info-box" style="margin-bottom:14px;">' +
  ...
  html += '<button class="btn-gold" style="margin-top:12px;" onclick="salvarProgressoDoDiaAgora(\'' + nome.replace(/'/g,"\\'") + '\')">' + (editandoOntem ? 'Salvar informações de ontem' : 'Salvar informações de hoje') + '</button>' +
