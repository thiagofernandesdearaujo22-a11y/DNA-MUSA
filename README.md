  ...
  <div class="screen">
    ...
    <div class="view" data-view="personal">
      ...
      <div id="personal-dashboard">
        ...
        <div class="section-colapsavel" style="margin-top:22px;background:var(--card);border:1px solid var(--border);border-radius:14px;padding:14px;">
          <div style="display:flex;justify-content:space-between;align-items:center;cursor:pointer;" onclick="alternarSecaoColapsavel('dash-comunicacao')">
            <span style="display:flex;align-items:center;gap:10px;">
              <span style="width:32px;height:32px;border-radius:9px;background:var(--card-2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="ti ti-message-circle" style="font-size:15px;color:var(--gold-soft);"></i></span>
          ...
          <div id="conteudo-dash-comunicacao" style="display:none;margin-top:12px;">
        ...
        <div class="section-colapsavel" style="margin-top:14px;background:var(--card);border:1px solid var(--border);border-radius:14px;padding:14px;">
          <div style="display:flex;justify-content:space-between;align-items:center;cursor:pointer;" onclick="alternarSecaoColapsavel('dash-ferramentas-treino')">
            <span style="display:flex;align-items:center;gap:10px;">
              <span style="width:32px;height:32px;border-radius:9px;background:var(--card-2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="ti ti-barbell" style="font-size:15px;color:var(--gold-soft);"></i></span>
        ...
        <div class="section-colapsavel" style="margin-top:14px;background:var(--card);border:1px solid var(--border);border-radius:14px;padding:14px;">
          <div style="display:flex;justify-content:space-between;align-items:center;cursor:pointer;" onclick="alternarSecaoColapsavel('dash-inteligencia')">
            <span style="display:flex;align-items:center;gap:10px;">
              <span style="width:32px;height:32px;border-radius:9px;background:var(--card-2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="ti ti-trending-up" style="font-size:15px;color:var(--gold-soft);"></i></span>
          ...
          <div id="conteudo-dash-inteligencia" style="display:none;margin-top:12px;">
        ...
        <div class="section-colapsavel" style="margin-top:14px;background:var(--card);border:1px solid var(--border);border-radius:14px;padding:14px;">
          <div style="display:flex;justify-content:space-between;align-items:center;cursor:pointer;" onclick="alternarSecaoColapsavel('dash-relatorios')">
            <span style="display:flex;align-items:center;gap:10px;">
              <span style="width:32px;height:32px;border-radius:9px;background:var(--card-2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="ti ti-report" style="font-size:15px;color:var(--gold-soft);"></i></span>
              <p class="section-label" style="margin:0;">Relatórios da semana</p>
            </span>
            <i class="ti ti-chevron-down" id="chevron-dash-relatorios" style="color:var(--gold-soft);font-size:16px;transition:transform .2s;"></i>
          </div>
          <div id="conteudo-dash-relatorios" style="display:none;margin-top:12px;">
