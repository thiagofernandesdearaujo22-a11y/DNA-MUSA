...
function renderCheckInEHabitos(nome){
  ...
  function botaoEscala(campo, valorAtual){
    return [1,2,3,4,5].map(function(n){
      return '<span class="chip" style="flex:1;text-align:center;' + (valorAtual === n ? 'background:var(--gold-soft);color:#1A1409;border-color:var(--gold-soft);' : '') + '" onclick="salvarCampoCheckInEmocional(\'' + nome.replace(/'/g,"\\'") + '\',\'' + campo + '\',' + n + ')">' + n + '</span>';
    }).join('');
  }
  ...
  let html = '<p class="section-label" style="margin-top:0;margin-bottom:10px;">' + (editandoOntem ? 'Preenchendo o dia de ontem (' + dataFormatadaEmEdicao + ')' : 'Meu progresso hoje') + '</p>' +
    ...
    '<div class="info-box" style="margin-bottom:14px;">' +
      '<p class="txt" style="font-size:12px;margin-bottom:8px;">Humor</p><div style="display:flex;justify-content:space-between;gap:6px;margin-bottom:16px;">' + botaoEscala('humor', checkin.humor) + '</div>' +
      '<p class="txt" style="font-size:12px;margin-bottom:8px;">Ansiedade</p><div style="display:flex;justify-content:space-between;gap:6px;margin-bottom:16px;">' + botaoEscala('ansiedade', checkin.ansiedade) + '</div>' +
      '<p class="txt" style="font-size:12px;margin-bottom:8px;">Disposição</p><div style="display:flex;justify-content:space-between;gap:6px;">' + botaoEscala('disposicao', checkin.disposicao) + '</div>' +
    '</div>' +
    '<div class="info-box" style="margin-bottom:14px;">' +
...
const exerciciosBanco = [
  ...
  {nome:'ELEVAÇÃO FROG', grupo:'Glúteos', ambiente:'Academia', nivel:'A definir', metodo:'', video:'https://youtu.be/j4_-w9BcarQ', camada:'acessorio', nivelMinimo:'Iniciante'},
  ...
  {nome:'FLEXÃO DE JOELHOS COM BOLA ADAPTADO', grupo:'Isquiotibiais', ambiente:'Academia', nivel:'A definir', metodo:'', video:'https://youtu.be/DgDD-47bVGk', camada:'base', nivelMinimo:'Intermediário'},
  ...
  {nome:'FLEXÃO DE JOELHOS COM BOLA', grupo:'Isquiotibiais', ambiente:'Academia', nivel:'A definir', metodo:'', video:'https://youtu.be/H0nTtztJK8M', camada:'base', nivelMinimo:'Intermediário'},
  ...
  {nome:'FROG NO SOLO', grupo:'Glúteos', ambiente:'Academia', nivel:'A definir', metodo:'', video:'https://youtu.be/tWdgdM3B5rA', camada:'acessorio', nivelMinimo:'Iniciante'},
