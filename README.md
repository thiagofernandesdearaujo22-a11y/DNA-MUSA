[dna_musa_28.html](https://github.com/user-attachments/files/32424044/dna_musa_28.html)
<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
async function confirmarMensagemEmMassa(){
  ...
  for(let i = 0; i < destinatarias.length; i++){
    ...
    area.innerHTML = '<p class="txt" style="color:var(--text-faint);">Enviando ' + (i+1) + ' de ' + destinatarias.length + '... (de propósito, com pausa entre cada uma, pra proteger seu WhatsApp de bloqueio)</p>';
